> **Note (2026-06-11):** This is the original, full project specification, preserved as
> the narrative overview. It predates the canonical model in `docs/` and the
> Madlanga-first build order — where they conflict, the canonical docs and
> `docs/project-state.md` win. The public front door is now the root `README.md`.
